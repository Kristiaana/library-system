...
<template>
  <UModal
    ...
    :ui="{
      content:
        'w-[90vw] max-w-[320px] fixed divide-y flex flex-col focus:outline-none !bg-[var(--globals--backgrounds--basic)] !border border-[var(--globals--strokes--block)] !ring-0 !shadow-none !outline-none !rounded-2xl',
